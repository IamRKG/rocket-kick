export default function About() {
    return (
      <div className="container mx-auto px-6 py-16">
        <h1 className="text-4xl font-bold mb-8">About Rocket Kick</h1>
        <p className="text-lg mb-6">
          Rocket Kick Software and Consulting Services is a leading technology company specializing in custom software development and expert consulting. With years of experience and a team of skilled professionals, we help businesses of all sizes leverage cutting-edge technology to achieve their goals.
        </p>
        <p className="text-lg mb-6">
